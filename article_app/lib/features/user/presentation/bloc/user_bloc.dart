...
import 'package:article_app/features/user/domain/usecases/add_user.dart';
import 'package:article_app/features/user/domain/usecases/delete_user_by_id.dart';
import 'package:article_app/features/user/domain/usecases/edit_user_by_id.dart';
import 'package:article_app/features/user/domain/usecases/get_user_by_id.dart';
...
class UserBloc extends Bloc<UserEvent, UserState> {
  ...
  UserBloc({
    ...
    required this.deleteUserById, required Object getUser,
